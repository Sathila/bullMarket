...
$sql="update tblcompany set Vimage1=:vimage1 where id=:id";
...
<head>
	...
	<title>BULL MARKET | Admin Update Image 1</title>
...
<?php 
$id=intval($_GET['imgid']);
$sql ="SELECT Vimage1 from tblcompany where tblcompany.id=:id";
$query = $dbh -> prepare($sql);
$query-> bindParam(':id', $id, PDO::PARAM_STR);
$query->execute();
