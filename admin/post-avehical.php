...
if(strlen($_SESSION['alogin'])==0) {	
	...
	<html lang="en" class="no-js">
		<head>
			...
			<title>BULL MARKET | Admin Sell Stocks</title>
			<!-- Font awesome -->
			...
			<div class="ts-main-content">
				...
				<div class="content-wrapper">
					<div class="container-fluid">
						<div class="row">
							<div class="col-md-12">
								<h2 class="page-title">Post A Company</h2>
								<div class="row">
									<div class="col-md-12">
											...
											<div class="panel-body">
												<form method="post" class="form-horizontal" enctype="multipart/form-data">
													<div class="form-group">
														<label class="col-sm-2 control-label">Company Title<span style="color:red">*</span></label>
														<div class="col-sm-4">
													...
													<div class="form-group">
														<label class="col-sm-2 control-label">Company Overview<span style="color:red">*</span></label>
														<div class="col-sm-10">
															<textarea class="form-control" name="vehicalorcview" rows="3" required></textarea>
														</div>
													</div>
													<div class="form-group">
														<label class="col-sm-2 control-label">Price Per Stock(in USD)<span style="color:red">*</span></label>
														<div class="col-sm-4">
