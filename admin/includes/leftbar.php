<nav class="ts-sidebar">
	<ul class="ts-sidebar-menu">
		...
		<li><a href="#"><i class="fa fa-sitemap"></i>Stocks</a>
			<ul>
				<li><a href="post-avehical.php">Sell Stocks</a></li>
				<li><a href="manage-vehicles.php">Manage Stocks</a></li>
			</ul>
		</li>
		<li><a href="manage-bookings.php"><i class="fa fa-users"></i>Manage Purchasing</a></li>
