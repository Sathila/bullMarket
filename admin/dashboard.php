...
<html lang="en" class="no-js">
	<head>
		...
		<title>BULL MARKET | Admin Dashboard</title>
									...
									<div class="row">
										<div class="col-md-3">
											<div class="panel panel-default">
												...
												<a href="reg-users.php" class="block-anchor panel-footer">User List<i class="fa fa-arrow-right"></i></a>
											</div>
										</div>
										<div class="col-md-3">
											<div class="panel panel-default">
												<div class="panel-body bk-success text-light">
													<div class="stat-panel text-center">
														...
														<div class="stat-panel-title text-uppercase">Listed Stocks</div>
													</div>
												</div>
												<a href="manage-vehicles.php" class="block-anchor panel-footer text-center">Stocks List<i class="fa fa-arrow-right"></i></a>
											</div>
										</div>
										<div class="col-md-3">
											<div class="panel panel-default">
												<div class="panel-body bk-info text-light">
													<div class="stat-panel text-center">
														...
														<div class="stat-panel-title text-uppercase">Sold Stocks</div>
													</div>
												</div>
												<a href="manage-bookings.php" class="block-anchor panel-footer text-center">Sold Stock Details<i class="fa fa-arrow-right"></i></a>
											</div>
										</div>
										<div class="col-md-3">
											<div class="panel panel-default">
												<div class="panel-body bk-warning text-light">
													<div class="stat-panel text-center">
														...
														<div class="stat-panel-title text-uppercase">Listed Companies</div>
													</div>
												</div>
												<a href="manage-brands.php" class="block-anchor panel-footer text-center">Compay Details<i class="fa fa-arrow-right"></i></a>
											</div>
										</div>
									</div>
								</div>
