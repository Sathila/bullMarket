...
$sql="update tblcompany set Vimage2=:vimage where id=:id";
...
<head>
	...
	<title>BULL MARKET | Admin Update Image 2</title>
...
<?php 
$id=intval($_GET['imgid']);
$sql ="SELECT Vimage2 from tblcompany where tblcompany.id=:id";
$query = $dbh -> prepare($sql);
$query-> bindParam(':id', $id, PDO::PARAM_STR);
$query->execute();
