    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 col-md-push-6 text-right">
          <div class="footer_widget">
            ...
            <ul>
              ...
              <li><a href="https://www.twwitter.com" target="_blank"><i class="fa fa-twitter-square" aria-hidden="true"></i></a></li>
        ...
        <div class="col-md-6 col-md-pull-6">
          <p class="copy-right">Copyright &copy; <?php echo date('Y') ?> BULL MARKET All Rights Reserved</p>
        </div>
      </div>
    </div>
  </div>
